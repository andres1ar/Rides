...
class DetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.carbonEmissionBtn.setOnClickListener {
            findNavController().navigate(DetailFragmentDirections.actionDetailFragmentToCarbonEmissionBottomSheet(vehicle.kilometrage))
        }
